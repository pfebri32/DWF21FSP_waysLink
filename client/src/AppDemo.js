...
// Layouts.
import DashboardLayout from './new/components/Layouts/DashboardLayout';

// Pages.
import Home from './new/pages/Home';
import Template from './new/pages/Template';
import TemplateContentCreate from './new/pages/Templates/Create';
import TemplateContentEdit from './new/pages/Templates/Edit';
import MyLink from './new/pages/MyLink';
import Profile from './new/pages/Profile';
import Logout from './pages/Logout';
import TemplateView from './new/pages/Templates/View';
